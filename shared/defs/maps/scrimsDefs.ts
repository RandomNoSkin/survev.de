...
export const mapDef: PartialMapDef = {
    ...
    lootTable: {
        tier_world: [
            { name: "tier_guns", count: 1, weight: 0.26995 }, // TODO get more data on this from original 30%
        ...
        densitySpawns: [
            {
                ...
                loot_tier_1: 24,
                loot_tier_beach: 12,
                stone_07: 10, // large stones
                tree_14: 2, //coconut tree
            },
        ],
        fixedSpawns: [
            {
                ...
                house_red_02: { small: 15, large: 15,},
                teahouse_complex_01su: {
                    small: 5,
                    large: 5,
                },
                barn_01: { small: 8, large: 8,}, //green houses
                barn_02: { small: 2, large: 2,},
                hut_01: 14, // huts
                hut_02: 3, // spas hut
                hut_03: 2, // scout hut
                ...
                cache_01: 2, // flare stone
                cache_02: 1, // mosin tree
                cache_07: 2, //barrel
                bunker_structure_01: 2, // ak74 bunker
                bunker_structure_02: 1, // vector bunker
                bunker_structure_03: 2, // storm bunker
                bunker_structure_04: 3, // sea bunker
                bunker_structure_05: 2, // river bunker
                warehouse_complex_01: 2, // docks
                chest_01: 1,
                chest_03: 1, // river chest
                mil_crate_02: { odds: 0.5 }, // ot chest
                tree_02: 20, // axe logs
                workshop_complex_01: { small: 1, large: 1,},
                mansion_structure_01: { small: 2, large: 2,},
                police_01: { small: 2, large: 2,},
                bank_01: { small: 2, large: 2,},
            },
        ],
        randomSpawns: [
            /*{
...
export const Scrims = util.mergeDeep({}, Comp, mapDef);
