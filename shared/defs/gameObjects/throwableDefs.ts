...
export const ThrowableDefs: Record<string, ThrowableDef> = {
    ...
    dynamite: {
        ...
        speed: { equip: 0, attack: 0 },
        lootImg: {
            sprite: "loot-throwable-dynamite.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.2,
        ...
        worldImg: {
            sprite: "proj-dynamite-nopin.img",
            scale: 0.12,
            tint: 0xffffff,
        },
        handImg: {
    ...
    mirv_mini_usas: { // added to allow more customization on the modded saiga
        name: "MIRV Usas",
        type: "throwable",
        quality: 0,
        explosionType: "explosion_mirv_mini",
